            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    <div class="card-header">
                        <h4>Edit Company
                            <a href="{{ route('companies.index') }}" class="btn btn-primary float-end">Back</a>
                        </h4>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('companies.update', $companies->id) }}" method="POST">
                            ...
                            {{-- <div class="mb-3">
                                <label>No</label>
                                <input type="text" name="no" class="form-control" value="{{ $companies->no }}" />    
                                @error('no') <span class="text-danger">{{ $message }}</span> @enderror
                            </div> --}}

                            <div class="mb-3">
                                <label>Code</label>
                                <input type="text" name="code" class="form-control" value="{{ $companies->code }}" />    
